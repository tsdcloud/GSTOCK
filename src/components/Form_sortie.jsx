...
export default function Form_sortie () {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch( "http://172.19.120.186:8002/api/exit_vouchers/",{
                method: "POST",
                headers: myheaders,
                body: JSON.stringify ({
                    "name":name,
    ...
    return (
        ...
        <div class="form_sortie">

            {/* Contenu principal */}
            <div className="flex justify-between items-center mt-20 shadow-md">
                <h1 className="text-3xl font-bold">Enregistrement d'un nouveau bon de sortie</h1>
            ...
            <div className="bg-[#f2e4d0] p-2 rounded-xl shadow-lg justify-center items-center mt-20 w-250 ">
                ...
                <form className="mt-5">
                    ...
                    <div className="mb-4">
                        ...
                        <select 
                            ...
                            className="mt-1 block w-full p-2 border rounded-md focus:ring-blue-500 bg-white focus:border-blue-500">
                                ...
                                <option value="option3">Comptabilité matière</option>
                    ...
                    <div className="mb-4">
                    <label className="block texet-left text-sm font-medium text-gray-700">
                     Entrez la quantité<span className="text-red-500">*</span>
                    </label>
                    <input 
                       type="text"
