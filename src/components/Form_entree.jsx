...
export default function Form_entree () {
    ...
    return (
        ...
        <div className="form_entree">

            {/* Contenu principal */}
            <div className="flex justify-between items-center mt-20 shadow-md">
                <h1 className="text-3xl font-bold">Enregistrement d'un nouveau bon d'entrée</h1>
            ...
            <div className="bg-[#f2e4d0] p-2 rounded-xl shadow-lg justify-center items-center mt-20 w-250 ">
                ...
                <div className="mb-4">
                    ...
                    <div className="mb-4">
                    <label className="block text-left text-sm font-medium text-gray-700">
                     Entrez le prix<span className="text-red-500">*</span>
                    </label>
                    <input 
                       type="text"
                        className="mt-1 block w-full bg-white p-2 border rounded-md focus:ring-blue-500 focus:border-blue-500"
